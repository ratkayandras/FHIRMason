...
class OperationResultFromTest {
    ...
    fun `round-trip fromParameters toParameters reconstructs nested parts - two-level`() {
        ...
        assertFalse(reconstructed.parameter.any { it.name == "address.city" })
        assertFalse(reconstructed.parameter.any { it.name == "address.country" })
    ...
    fun `round-trip fromParameters toParameters reconstructs deeply nested parts - three-level`() {
        ...
        assertFalse(reconstructed.parameter.any { it.name == "outer.inner.leaf" })
    ...
    fun `round-trip fromParameters toParameters handles mixed flat and nested parameters`() {
        ...
        assertTrue(reconstructed.parameter.any { it.name == "patient" })
        assertTrue(reconstructed.parameter.any { it.name == "flag" })
        assertFalse(reconstructed.parameter.any { it.name == "contact.phone" })
        assertFalse(reconstructed.parameter.any { it.name == "contact.email" })
